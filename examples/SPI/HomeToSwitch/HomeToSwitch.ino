...
const auto home_parameters_homing_to_switch_real = tmc51x0::HomeParameters{}
...
const auto switch_parameters_homing_to_switch = tmc51x0::SwitchParameters{}
                                                    .withLeftStopEnabled (true);

const auto home_parameters_homing_off_switch_real = tmc51x0::HomeParameters{}
                                                        .withRunCurrent (25)    // (percent)
                                                        .withHoldCurrent (10)   // (percent)
...
const auto switch_parameters_homing_off_switch = tmc51x0::SwitchParameters{}
