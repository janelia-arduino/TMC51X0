...
static void
test_gconf_gstat_nodeconf_ioin (void)
{
  // --------------------------------------------------------------------------
  // Gconf (0x00)
  // --------------------------------------------------------------------------
...
static void
test_shortconf_drvconf_iholdirun (void)
{
  // --------------------------------------------------------------------------
  // ShortConf (0x09)
  // --------------------------------------------------------------------------
...
static void
test_microstep_and_driver_registers (void)
{
  // --------------------------------------------------------------------------
  // Mslutstart (0x69)
  // --------------------------------------------------------------------------
