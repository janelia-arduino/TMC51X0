...
static void
test_homed_requires_confirmed_stall_for_stall_home (void)
{
  FakeInterface interface;
  TMC51X0 stepper;
...
static void
test_homed_accepts_stall_stop_event_for_stall_home (void)
{
  FakeInterface interface;
  TMC51X0 stepper;
  initStepper (stepper, interface);
...
static void
test_read_health_status_reports_faults_and_resync_need (void)
{
  FakeInterface interface;
  TMC51X0 stepper;
  initStepper (stepper, interface);
...
static void
test_recover_if_unhealthy_marks_drift_and_recovers (void)
{
  FakeInterface interface;
  TMC51X0 stepper;
  initStepper (stepper, interface);
