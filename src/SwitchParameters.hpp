...
struct SwitchParameters
{
  ...
  constexpr SwitchParameters
  withLeftStopEnabled (bool value) const
  {
  ...
  constexpr SwitchParameters
  withRightStopEnabled (bool value) const
  {
    return SwitchParameters (
        left_stop_enabled,
        value,
  ...
  constexpr SwitchParameters
  withInvertLeftPolarity (bool value) const
  {
    return SwitchParameters (
        left_stop_enabled,
        right_stop_enabled,
  ...
  constexpr SwitchParameters
  withInvertRightPolarity (bool value) const
  {
    return SwitchParameters (
        left_stop_enabled,
        right_stop_enabled,
  ...
  constexpr SwitchParameters
  withSwapLeftRight (bool value) const
  {
    return SwitchParameters (
        left_stop_enabled,
        right_stop_enabled,
  ...
  constexpr SwitchParameters
  withLatchLeftActive (bool value) const
  {
    return SwitchParameters (
        left_stop_enabled,
        right_stop_enabled,
  ...
  constexpr SwitchParameters
  withLatchLeftInactive (bool value) const
  {
    return SwitchParameters (
        left_stop_enabled,
        right_stop_enabled,
  ...
  constexpr SwitchParameters
  withLatchRightActive (bool value) const
  {
    return SwitchParameters (
        left_stop_enabled,
        right_stop_enabled,
  ...
  constexpr SwitchParameters
  withLatchRightInactive (bool value) const
  {
    return SwitchParameters (
        left_stop_enabled,
        right_stop_enabled,
  ...
  constexpr SwitchParameters
  withLatchEncoderEnabled (bool value) const
  {
    return SwitchParameters (
        left_stop_enabled,
        right_stop_enabled,
