...
void
Driver::setup (tmc51x0::DriverParameters parameters)
{
...
void
Driver::setEnableHardwarePin (size_t hardware_enable_pin)
{
...
uint8_t
Driver::readActualCurrentScaling ()
{
  Registers::DrvStatus drv_status;
  drv_status.raw = registers_ptr_->read (Registers::DrvStatusAddress);
...
void
Driver::writeEnabledToff (uint8_t toff)
{
...
void
Driver::initialize (Registers &registers)
{
