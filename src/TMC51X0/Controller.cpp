...
void
Controller::setup (tmc51x0::ControllerParameters parameters)
{
...
bool
Controller::stepAndDirectionMode ()
{
  Registers::Ioin ioin;
...
void
Controller::beginRampToZeroVelocity ()
{
...
void
Controller::endRampToZeroVelocity ()
{
...
int32_t
Controller::readTargetPosition ()
{
  return registers_ptr_->read (Registers::XtargetAddress);
}

void
Controller::writeTargetPosition (int32_t position)
{
...
void
Controller::writeComparePosition (int32_t position)
{
...
void
Controller::setupSwitches ()
{
  writeSwitchParameters (setup_switch_parameters_);
}

void
Controller::setupSwitches (SwitchParameters parameters)
{
...
void
Controller::initialize (Registers &registers)
{
