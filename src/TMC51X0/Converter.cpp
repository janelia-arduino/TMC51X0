...
void
Converter::setup (ConverterParameters parameters)
{
...
HomeParameters
Converter::homeParametersRealToChip (HomeParameters parameters)
{
...
int32_t
Converter::positionChipToReal (int32_t position_chip)
{
  return position_chip / (int32_t)converter_parameters_.microsteps_per_real_position_unit;
}

int32_t
Converter::positionRealToChip (int32_t position_real)
{
  return position_real * (int32_t)converter_parameters_.microsteps_per_real_position_unit;
}

int32_t
Converter::velocityChipToReal (int32_t velocity_chip)
{
  return velocityHzToReal (velocityChipToHz (velocity_chip));
}

int32_t
Converter::velocityFloatToChip (float velocity_real)
{
  float velocity_hz = velocity_real * (float)converter_parameters_.microsteps_per_real_position_unit / (float)converter_parameters_.seconds_per_real_velocity_unit;
  return velocityHzToChip ((int32_t)velocity_hz);
}

int32_t
Converter::velocityRealToChip (int32_t velocity_real)
{
  return velocityHzToChip (velocityRealToHz (velocity_real));
}

int32_t
Converter::tstepToVelocityReal (int32_t tstep)
{
  return velocityHzToReal (tstepToVelocityHz (tstep));
}

int32_t
Converter::velocityRealToTstep (int32_t velocity_real)
{
  return velocityHzToTstep (velocityRealToHz (velocity_real));
}

int32_t
Converter::velocityChipToTstep (int32_t velocity_chip)
{
  return velocityHzToTstep (velocityChipToHz (velocity_chip));
}

int32_t
Converter::velocityTstepToChip (int32_t tstep)
{
  return velocityHzToChip (tstepToVelocityHz (tstep));
}

int32_t
Converter::accelerationChipToReal (int32_t acceleration_chip)
{
  return accelerationHzPerSToReal (accelerationChipToHzPerS (acceleration_chip));
}

int32_t
Converter::accelerationRealToChip (int32_t acceleration_real)
{
  return accelerationHzPerSToChip (accelerationRealToHzPerS (acceleration_real));
}

uint8_t
Converter::percentToGlobalCurrentScaler (uint8_t percent)
{
...
uint8_t
Converter::percentToCurrentSetting (uint8_t percent)
{
  uint8_t constrained_percent = constrain_ (percent,
                                            PERCENT_MIN,
                                            PERCENT_MAX);
...
uint8_t
Converter::currentSettingToPercent (uint8_t current_setting)
{
...
uint8_t
Converter::percentToHoldDelaySetting (uint8_t percent)
{
  uint8_t constrained_percent = constrain_ (percent,
                                            PERCENT_MIN,
                                            PERCENT_MAX);
...
uint8_t
Converter::holdDelaySettingToPercent (uint8_t hold_delay_setting)
{
...
uint8_t
Converter::percentToPwmSetting (uint8_t percent)
{
  uint8_t constrained_percent = constrain_ (percent,
                                            PERCENT_MIN,
                                            PERCENT_MAX);
...
uint32_t
Converter::millisecondsToZeroWaitDuration (uint32_t milliseconds)
{
...
int32_t
Converter::velocityChipToHz (int32_t velocity_chip)
{
  int64_t velocity_hz;
...
int32_t
Converter::velocityHzToChip (int32_t velocity_hz)
{
...
int32_t
Converter::velocityRealToHz (int32_t velocity_real)
{
  int32_t velocity_hz;
...
int32_t
Converter::velocityHzToReal (int32_t velocity_hz)
{
...
int32_t
Converter::tstepToVelocityHz (int32_t tstep)
{
  if (tstep == 0)
    {
...
int32_t
Converter::velocityHzToTstep (int32_t velocity_hz)
{
  if (velocity_hz == 0)
    {
...
int32_t
Converter::accelerationChipToHzPerS (int32_t acceleration_chip)
{
...
int32_t
Converter::accelerationHzPerSToChip (int32_t acceleration_hz_per_s)
{
...
int32_t
Converter::accelerationRealToHzPerS (int32_t acceleration_real)
{
...
int32_t
Converter::accelerationHzPerSToReal (int32_t acceleration_hz_per_s)
{
...
uint32_t
Converter::constrain_ (uint32_t value, uint32_t low, uint32_t high)
{
