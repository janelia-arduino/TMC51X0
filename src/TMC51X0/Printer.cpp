...
void
Printer::setup (Print &print)
{
  print_ptr_ = &print;
}

void
Printer::readAndPrintGconf ()
{
  Registers::Gconf gconf;
  gconf.raw = registers_ptr_->read (Registers::GconfAddress);
  printRegister (gconf);
}

void
Printer::printRegister (Registers::Gconf gconf)
{
  printRegisterPortion ("gconf", gconf.raw, HEX);
...
void
Printer::readClearAndPrintGstat ()
{
...
void
Printer::printRegister (Registers::Gstat gstat)
{
...
void
Printer::printRegister (Registers::Ioin ioin)
{
  printRegisterPortion ("ioin", ioin.raw, HEX);
...
void
Printer::readAndPrintSwMode ()
{
  Registers::SwMode sw_mode;
  sw_mode.raw = registers_ptr_->read (Registers::SwModeAddress);
  printRegister (sw_mode);
}

void
Printer::printRegister (Registers::SwMode sw_mode)
{
  printRegisterPortion ("sw_mode", sw_mode.raw, HEX);
...
void
Printer::printRegister (Registers::RampStat ramp_stat)
{
  printRegisterPortion ("ramp_stat", ramp_stat.raw, HEX);
...
void
Printer::readAndPrintChopconf ()
{
  Registers::Chopconf chopconf;
  chopconf.raw = registers_ptr_->read (Registers::ChopconfAddress);
  printRegister (chopconf);
}

void
Printer::printRegister (Registers::Chopconf chopconf)
{
  printRegisterPortion ("chopconf", chopconf.raw, HEX);
...
void
Printer::printRegister (Registers::DrvStatus drv_status)
{
  printRegisterPortion ("drv_status", drv_status.raw, HEX);
...
void
Printer::getStoredAndPrintPwmconf ()
{
...
void
Printer::printRegister (Registers::Pwmconf pwmconf)
{
  printRegisterPortion ("pwmconf", pwmconf.raw, HEX);
...
void
Printer::readAndPrintPwmScale ()
{
  Registers::PwmScale pwm_scale;
  pwm_scale.raw = registers_ptr_->read (Registers::PwmScaleAddress);
  printRegister (pwm_scale);
}

void
Printer::printRegister (Registers::PwmScale pwm_scale)
{
  printRegisterPortion ("pwm_scale", pwm_scale.raw, HEX);
...
void
Printer::readAndPrintPwmAuto ()
{
  Registers::PwmAuto pwm_auto;
  pwm_auto.raw = registers_ptr_->read (Registers::PwmAutoAddress);
  printRegister (pwm_auto);
}

void
Printer::printRegister (Registers::PwmAuto pwm_auto)
{
  printRegisterPortion ("pwm_auto", pwm_auto.raw, HEX);
...
void
Printer::initialize (Registers &registers)
{
  print_ptr_ = &Serial;
...
void
Printer::printRegisterPortion (const char *str, uint32_t value, int base)
{
