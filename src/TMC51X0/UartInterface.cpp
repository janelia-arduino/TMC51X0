...
void
UartInterface::setup (UartParameters uart_parameters)
{
...
size_t
UartInterface::serialWrite (uint8_t c)
{
  if (uart_parameters_.uart_ptr != nullptr)
    {
