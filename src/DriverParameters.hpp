...
struct DriverParameters
{
  ...
  constexpr DriverParameters
  withGlobalCurrentScaler (uint8_t value) const
  {
  ...
  constexpr DriverParameters
  withRunCurrent (uint8_t value) const
  {
    return DriverParameters (
  ...
  constexpr DriverParameters
  withHoldCurrent (uint8_t value) const
  {
    return DriverParameters (
        global_current_scaler,
        run_current,
  ...
  constexpr DriverParameters
  withHoldDelay (uint8_t value) const
  {
    return DriverParameters (
        global_current_scaler,
        run_current,
  ...
  constexpr DriverParameters
  withPwmOffset (uint8_t value) const
  {
    return DriverParameters (
        global_current_scaler,
        run_current,
  ...
  constexpr DriverParameters
  withPwmGradient (uint8_t value) const
  {
    return DriverParameters (
        global_current_scaler,
        run_current,
  ...
  constexpr DriverParameters
  withMotorDirection (MotorDirection value) const
  {
    return DriverParameters (
        global_current_scaler,
        run_current,
  ...
  constexpr DriverParameters
  withStandstillMode (StandstillMode value) const
  {
    return DriverParameters (
        global_current_scaler,
        run_current,
  ...
  constexpr DriverParameters
  withChopperMode (ChopperMode value) const
  {
    return DriverParameters (
        global_current_scaler,
        run_current,
  ...
  constexpr DriverParameters
  withStealthChopThreshold (uint32_t value) const
  {
    return DriverParameters (
        global_current_scaler,
        run_current,
  ...
  constexpr DriverParameters
  withStealthChopEnabled (bool value) const
  {
    return DriverParameters (
        global_current_scaler,
        run_current,
  ...
  constexpr DriverParameters
  withCoolStepThreshold (uint32_t value) const
  {
    return DriverParameters (
        global_current_scaler,
        run_current,
  ...
  constexpr DriverParameters
  withCoolStepMin (uint8_t value) const
  {
    return DriverParameters (
        global_current_scaler,
        run_current,
  ...
  constexpr DriverParameters
  withCoolStepMax (uint8_t value) const
  {
    return DriverParameters (
        global_current_scaler,
        run_current,
  ...
  constexpr DriverParameters
  withCoolStepEnabled (bool value) const
  {
    return DriverParameters (
        global_current_scaler,
        run_current,
  ...
  constexpr DriverParameters
  withHighVelocityThreshold (uint32_t value) const
  {
    return DriverParameters (
        global_current_scaler,
        run_current,
  ...
  constexpr DriverParameters
  withHighVelocityFullstepEnabled (bool value) const
  {
    return DriverParameters (
        global_current_scaler,
        run_current,
  ...
  constexpr DriverParameters
  withStallGuardThreshold (int8_t value) const
  {
    return DriverParameters (
        global_current_scaler,
        run_current,
  ...
  constexpr DriverParameters
  withStallGuardFilterEnabled (bool value) const
  {
    return DriverParameters (
        global_current_scaler,
        run_current,
  ...
  constexpr DriverParameters
  withEnabledToff (uint8_t value) const
  {
    return DriverParameters (
        global_current_scaler,
        run_current,
  ...
  constexpr DriverParameters
  withDcTime (uint16_t value) const
  {
    return DriverParameters (
        global_current_scaler,
        run_current,
  ...
  constexpr DriverParameters
  withDcStallGuardThreshold (uint8_t value) const
  {
    return DriverParameters (
        global_current_scaler,
        run_current,
