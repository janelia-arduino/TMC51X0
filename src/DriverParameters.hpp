...
struct DriverParameters {
  ...
  constexpr DriverParameters(
      ...
      uint8_t hold_current = 20, uint8_t hold_delay = 5,
      uint8_t pwm_offset = 25, uint8_t pwm_gradient = 5,
      ...
      uint32_t stealth_chop_threshold = 100, bool stealth_chop_enabled = true,
      uint32_t cool_step_threshold = 150, uint8_t cool_step_min = 1,
      uint8_t cool_step_max = 0, bool cool_step_enabled = false,
      ...
      : global_current_scaler(global_current_scaler), run_current(run_current),
        ...
        motor_direction(motor_direction), standstill_mode(standstill_mode),
        chopper_mode(chopper_mode),
        stealth_chop_threshold(stealth_chop_threshold),
        stealth_chop_enabled(stealth_chop_enabled),
        cool_step_threshold(cool_step_threshold), cool_step_min(cool_step_min),
        cool_step_max(cool_step_max), cool_step_enabled(cool_step_enabled),
  ...
  constexpr DriverParameters withGlobalCurrentScaler(uint8_t value) const {
    return DriverParameters(
        value, run_current, hold_current, hold_delay, pwm_offset, pwm_gradient,
        automatic_current_control_enabled, motor_direction, standstill_mode,
        chopper_mode, stealth_chop_threshold, stealth_chop_enabled,
        cool_step_threshold, cool_step_min, cool_step_max, cool_step_enabled,
  ...
  constexpr DriverParameters withRunCurrent(uint8_t value) const {
    return DriverParameters(
        global_current_scaler, value, hold_current, hold_delay, pwm_offset,
        pwm_gradient, automatic_current_control_enabled, motor_direction,
        standstill_mode, chopper_mode, stealth_chop_threshold,
  ...
  constexpr DriverParameters withHoldCurrent(uint8_t value) const {
    return DriverParameters(
        global_current_scaler, run_current, value, hold_delay, pwm_offset,
        pwm_gradient, automatic_current_control_enabled, motor_direction,
        standstill_mode, chopper_mode, stealth_chop_threshold,
        stealth_chop_enabled, cool_step_threshold, cool_step_min, cool_step_max,
        cool_step_enabled, high_velocity_threshold,
  ...
  constexpr DriverParameters withHoldDelay(uint8_t value) const {
    return DriverParameters(
        global_current_scaler, run_current, hold_current, value, pwm_offset,
        pwm_gradient, automatic_current_control_enabled, motor_direction,
        standstill_mode, chopper_mode, stealth_chop_threshold,
        stealth_chop_enabled, cool_step_threshold, cool_step_min, cool_step_max,
        cool_step_enabled, high_velocity_threshold,
  ...
  constexpr DriverParameters withPwmOffset(uint8_t value) const {
    return DriverParameters(
        global_current_scaler, run_current, hold_current, hold_delay, value,
        pwm_gradient, automatic_current_control_enabled, motor_direction,
        standstill_mode, chopper_mode, stealth_chop_threshold,
        stealth_chop_enabled, cool_step_threshold, cool_step_min, cool_step_max,
        cool_step_enabled, high_velocity_threshold,
  ...
  constexpr DriverParameters withPwmGradient(uint8_t value) const {
    return DriverParameters(
        ...
        pwm_offset, value, automatic_current_control_enabled, motor_direction,
        standstill_mode, chopper_mode, stealth_chop_threshold,
        stealth_chop_enabled, cool_step_threshold, cool_step_min, cool_step_max,
        cool_step_enabled, high_velocity_threshold,
        high_velocity_fullstep_enabled, high_velocity_chopper_switch_enabled,
  ...
  constexpr DriverParameters
  withAutomaticCurrentControlEnabled(bool value) const {
    return DriverParameters(
        global_current_scaler, run_current, hold_current, hold_delay,
        pwm_offset, pwm_gradient, value, motor_direction, standstill_mode,
        chopper_mode, stealth_chop_threshold, stealth_chop_enabled,
        cool_step_threshold, cool_step_min, cool_step_max, cool_step_enabled,
        high_velocity_threshold, high_velocity_fullstep_enabled,
        high_velocity_chopper_switch_enabled, stall_guard_threshold,
  ...
  constexpr DriverParameters withMotorDirection(MotorDirection value) const {
    return DriverParameters(
        global_current_scaler, run_current, hold_current, hold_delay,
        pwm_offset, pwm_gradient, automatic_current_control_enabled, value,
        standstill_mode, chopper_mode, stealth_chop_threshold,
        stealth_chop_enabled, cool_step_threshold, cool_step_min, cool_step_max,
        cool_step_enabled, high_velocity_threshold,
        high_velocity_fullstep_enabled, high_velocity_chopper_switch_enabled,
  ...
  constexpr DriverParameters withStandstillMode(StandstillMode value) const {
    return DriverParameters(
        ...
        motor_direction, value, chopper_mode, stealth_chop_threshold,
        stealth_chop_enabled, cool_step_threshold, cool_step_min, cool_step_max,
        cool_step_enabled, high_velocity_threshold,
        high_velocity_fullstep_enabled, high_velocity_chopper_switch_enabled,
        stall_guard_threshold, stall_guard_filter_enabled,
  ...
  constexpr DriverParameters withChopperMode(ChopperMode value) const {
    return DriverParameters(
        global_current_scaler, run_current, hold_current, hold_delay,
        pwm_offset, pwm_gradient, automatic_current_control_enabled,
        motor_direction, standstill_mode, value, stealth_chop_threshold,
        stealth_chop_enabled, cool_step_threshold, cool_step_min, cool_step_max,
        cool_step_enabled, high_velocity_threshold,
        high_velocity_fullstep_enabled, high_velocity_chopper_switch_enabled,
        stall_guard_threshold, stall_guard_filter_enabled,
  ...
  constexpr DriverParameters withStealthChopThreshold(uint32_t value) const {
    return DriverParameters(
        global_current_scaler, run_current, hold_current, hold_delay,
        pwm_offset, pwm_gradient, automatic_current_control_enabled,
        motor_direction, standstill_mode, chopper_mode, value,
        stealth_chop_enabled, cool_step_threshold, cool_step_min, cool_step_max,
        cool_step_enabled, high_velocity_threshold,
        high_velocity_fullstep_enabled, high_velocity_chopper_switch_enabled,
        stall_guard_threshold, stall_guard_filter_enabled,
  ...
  constexpr DriverParameters withStealthChopEnabled(bool value) const {
    return DriverParameters(
        ...
        value, cool_step_threshold, cool_step_min, cool_step_max,
        cool_step_enabled, high_velocity_threshold,
        high_velocity_fullstep_enabled, high_velocity_chopper_switch_enabled,
        stall_guard_threshold, stall_guard_filter_enabled,
        short_to_ground_protection_enabled, enabled_toff, comparator_blank_time,
  ...
  constexpr DriverParameters withCoolStepThreshold(uint32_t value) const {
    return DriverParameters(
        ...
        pwm_offset, pwm_gradient, automatic_current_control_enabled,
        motor_direction, standstill_mode, chopper_mode, stealth_chop_threshold,
        stealth_chop_enabled, value, cool_step_min, cool_step_max,
        cool_step_enabled, high_velocity_threshold,
        high_velocity_fullstep_enabled, high_velocity_chopper_switch_enabled,
        stall_guard_threshold, stall_guard_filter_enabled,
        short_to_ground_protection_enabled, enabled_toff, comparator_blank_time,
  ...
  constexpr DriverParameters withCoolStepMin(uint8_t value) const {
    return DriverParameters(
        ...
        pwm_offset, pwm_gradient, automatic_current_control_enabled,
        motor_direction, standstill_mode, chopper_mode, stealth_chop_threshold,
        stealth_chop_enabled, cool_step_threshold, value, cool_step_max,
        cool_step_enabled, high_velocity_threshold,
        high_velocity_fullstep_enabled, high_velocity_chopper_switch_enabled,
        stall_guard_threshold, stall_guard_filter_enabled,
        short_to_ground_protection_enabled, enabled_toff, comparator_blank_time,
  ...
  constexpr DriverParameters withCoolStepMax(uint8_t value) const {
    return DriverParameters(
        ...
        pwm_offset, pwm_gradient, automatic_current_control_enabled,
        motor_direction, standstill_mode, chopper_mode, stealth_chop_threshold,
        stealth_chop_enabled, cool_step_threshold, cool_step_min, value,
        cool_step_enabled, high_velocity_threshold,
        high_velocity_fullstep_enabled, high_velocity_chopper_switch_enabled,
        stall_guard_threshold, stall_guard_filter_enabled,
        short_to_ground_protection_enabled, enabled_toff, comparator_blank_time,
  ...
  constexpr DriverParameters
  withHighVelocityChopperSwitchEnabled(bool value) const {
    return DriverParameters(
        global_current_scaler, run_current, hold_current, hold_delay,
        pwm_offset, pwm_gradient, automatic_current_control_enabled,
        motor_direction, standstill_mode, chopper_mode, stealth_chop_threshold,
  ...
  constexpr DriverParameters
  withShortToGroundProtectionEnabled(bool value) const {
    return DriverParameters(
        global_current_scaler, run_current, hold_current, hold_delay,
        pwm_offset, pwm_gradient, automatic_current_control_enabled,
        motor_direction, standstill_mode, chopper_mode, stealth_chop_threshold,
  ...
  constexpr DriverParameters
  withComparatorBlankTime(ComparatorBlankTime value) const {
    return DriverParameters(
        global_current_scaler, run_current, hold_current, hold_delay,
        pwm_offset, pwm_gradient, automatic_current_control_enabled,
        motor_direction, standstill_mode, chopper_mode, stealth_chop_threshold,
