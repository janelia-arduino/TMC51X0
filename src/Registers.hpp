...
struct Registers {
  ...
  struct Gconf {
    ...
    bool en_pwm_mode() const { return EN_PWM_MODE::get(raw); }
    ...
    bool diag0_error() const { return DIAG0_ERROR::get(raw); }

    Gconf &diag0_otpw(bool v) {
      DIAG0_OTPW::set(raw, v);
      return *this;
    }
    bool diag0_otpw() const { return DIAG0_OTPW::get(raw); }

    Gconf &diag0_stall_int_step(bool v) {
      DIAG0_STALL_INT_STEP::set(raw, v);
      return *this;
    }
    bool diag0_stall_int_step() const { return DIAG0_STALL_INT_STEP::get(raw); }
    ...
    bool diag1_index() const { return DIAG1_INDEX::get(raw); }

    Gconf &diag1_onstate(bool v) {
      DIAG1_ONSTATE::set(raw, v);
      return *this;
    }
    bool diag1_onstate() const { return DIAG1_ONSTATE::get(raw); }

    Gconf &diag1_steps_skipped(bool v) {
      DIAG1_STEPS_SKIPPED::set(raw, v);
      return *this;
    }
    bool diag1_steps_skipped() const { return DIAG1_STEPS_SKIPPED::get(raw); }

    Gconf &diag0_int_pushpull(bool v) {
      DIAG0_INT_PUSHPULL::set(raw, v);
      return *this;
    }
    bool diag0_int_pushpull() const { return DIAG0_INT_PUSHPULL::get(raw); }
    ...
    bool small_hysteresis() const { return SMALL_HYSTERESIS::get(raw); }

    Gconf &stop_enable(bool v) {
      STOP_ENABLE::set(raw, v);
      return *this;
    }
    bool stop_enable() const { return STOP_ENABLE::get(raw); }

    Gconf &direct_mode(bool v) {
      DIRECT_MODE::set(raw, v);
      return *this;
    }
    bool direct_mode() const { return DIRECT_MODE::get(raw); }
  };
  ...
  struct Ioin {
    ...
    uint8_t version() const { return static_cast<uint8_t>(VERSION::get(raw)); }
  };
  ...
  struct ShortConf {
    ...
    bool shortdelay() const { return SHORTDELAY::get(raw); }
  };
  ...
  struct DrvConf {
    ...
    uint8_t bbmtime() const { return static_cast<uint8_t>(BBMTIME::get(raw)); }

    DrvConf &bbmclks(uint8_t v) {
      BBMCLKS::set(raw, v);
      return *this;
    }
    uint8_t bbmclks() const { return static_cast<uint8_t>(BBMCLKS::get(raw)); }
  ...
  struct IholdIrun {
    ...
    uint8_t ihold() const { return static_cast<uint8_t>(IHOLD::get(raw)); }

    IholdIrun &irun(uint8_t v) {
      IRUN::set(raw, v);
      return *this;
    }
    uint8_t irun() const { return static_cast<uint8_t>(IRUN::get(raw)); }
  ...
  struct EncConst {
    ...
    int16_t integer() const { return static_cast<int16_t>(INTEGER::get(raw)); }
  };
  ...
  struct EncStatus {
    ...
    EncStatus &n_event(bool v) {
      N_EVENT::set(raw, v);
      return *this;
    }
    bool n_event() const { return N_EVENT::get(raw); }

    EncStatus &deviation_warn(bool v) {
  ...
  struct Mscuract {
    ...
    uint16_t cur_b() const { return static_cast<uint16_t>(CUR_B::get(raw)); }

    Mscuract &cur_a(uint16_t v) {
      CUR_A::set(raw, v);
      return *this;
    }
    uint16_t cur_a() const { return static_cast<uint16_t>(CUR_A::get(raw)); }
  };
  struct Chopconf {
    uint32_t raw{0};
    ...
    uint8_t toff() const { return static_cast<uint8_t>(TOFF::get(raw)); }

    Chopconf &hstart(uint8_t v) {
      HSTART::set(raw, v);
      return *this;
    }
    uint8_t hstart() const { return static_cast<uint8_t>(HSTART::get(raw)); }
    ...
    bool fd3() const { return FD3::get(raw); }

    Chopconf &disfdcc(bool v) {
      DISFDCC::set(raw, v);
      return *this;
    }
    bool disfdcc() const { return DISFDCC::get(raw); }

    Chopconf &chm(bool v) {
      CHM::set(raw, v);
      return *this;
    }
    bool chm() const { return CHM::get(raw); }

    Chopconf &tbl(uint8_t v) {
      TBL::set(raw, v);
      return *this;
    }
    uint8_t tbl() const { return static_cast<uint8_t>(TBL::get(raw)); }

    Chopconf &vhighfs(bool v) {
      VHIGHFS::set(raw, v);
      return *this;
    }
    bool vhighfs() const { return VHIGHFS::get(raw); }

    Chopconf &vhighchm(bool v) {
      VHIGHCHM::set(raw, v);
      return *this;
    }
    bool vhighchm() const { return VHIGHCHM::get(raw); }

    Chopconf &tpfd(uint8_t v) {
      TPFD::set(raw, v);
      return *this;
    }
    uint8_t tpfd() const { return static_cast<uint8_t>(TPFD::get(raw)); }

    Chopconf &mres(uint8_t v) {
      MRES::set(raw, v);
      return *this;
    }
    uint8_t mres() const { return static_cast<uint8_t>(MRES::get(raw)); }
  ...
  struct Coolconf {
    ...
    uint8_t semin() const { return static_cast<uint8_t>(SEMIN::get(raw)); }

    Coolconf &seup(uint8_t v) {
      SEUP::set(raw, v);
      return *this;
    }
    uint8_t seup() const { return static_cast<uint8_t>(SEUP::get(raw)); }

    Coolconf &semax(uint8_t v) {
      SEMAX::set(raw, v);
      return *this;
    }
    uint8_t semax() const { return static_cast<uint8_t>(SEMAX::get(raw)); }

    Coolconf &sedn(uint8_t v) {
      SEDN::set(raw, v);
      return *this;
    }
    uint8_t sedn() const { return static_cast<uint8_t>(SEDN::get(raw)); }

    Coolconf &seimin(bool v) {
      SEIMIN::set(raw, v);
      return *this;
    }
    bool seimin() const { return SEIMIN::get(raw); }

    Coolconf &sgt(int8_t v) {
      SGT::set(raw, static_cast<uint32_t>(static_cast<uint8_t>(v)));
      return *this;
    }
    uint8_t sgt() const { return static_cast<uint8_t>(SGT::get(raw)); }

    Coolconf &sfilt(bool v) {
      SFILT::set(raw, v);
      return *this;
    }
    bool sfilt() const { return SFILT::get(raw); }
  };
  ...
  struct Dcctrl {
    ...
    uint8_t dc_sg() const { return static_cast<uint8_t>(DC_SG::get(raw)); }
  };
  ...
  struct Pwmconf {
    ...
    uint8_t pwm_ofs() const { return static_cast<uint8_t>(PWM_OFS::get(raw)); }
    ...
    uint8_t pwm_reg() const { return static_cast<uint8_t>(PWM_REG::get(raw)); }

    Pwmconf &pwm_lim(uint8_t v) {
      PWM_LIM::set(raw, v);
      return *this;
    }
    uint8_t pwm_lim() const { return static_cast<uint8_t>(PWM_LIM::get(raw)); }
  };
...
private:
  ...
  MirrorConfidence stored_confidence_[AddressCount] = {
      MirrorConfidence::Unknown};
  ...
  void seedStoredResetValue_(RegisterAddress register_address, uint32_t data);
