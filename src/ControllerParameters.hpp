...
struct ControllerParameters
{
  ...
  constexpr ControllerParameters
  withRampMode (RampMode value) const
  {
  ...
  constexpr ControllerParameters
  withStopMode (StopMode value) const
  {
    return ControllerParameters (
        ramp_mode,
        value,
  ...
  constexpr ControllerParameters
  withMaxVelocity (uint32_t value) const
  {
    return ControllerParameters (
        ramp_mode,
        stop_mode,
  ...
  constexpr ControllerParameters
  withMaxAcceleration (uint32_t value) const
  {
    return ControllerParameters (
        ramp_mode,
        stop_mode,
  ...
  constexpr ControllerParameters
  withStartVelocity (uint32_t value) const
  {
    return ControllerParameters (
        ramp_mode,
        stop_mode,
  ...
  constexpr ControllerParameters
  withStopVelocity (uint32_t value) const
  {
    return ControllerParameters (
        ramp_mode,
        stop_mode,
  ...
  constexpr ControllerParameters
  withFirstVelocity (uint32_t value) const
  {
    return ControllerParameters (
        ramp_mode,
        stop_mode,
  ...
  constexpr ControllerParameters
  withFirstAcceleration (uint32_t value) const
  {
    return ControllerParameters (
        ramp_mode,
        stop_mode,
  ...
  constexpr ControllerParameters
  withMaxDeceleration (uint32_t value) const
  {
    return ControllerParameters (
        ramp_mode,
        stop_mode,
  ...
  constexpr ControllerParameters
  withFirstDeceleration (uint32_t value) const
  {
    return ControllerParameters (
        ramp_mode,
        stop_mode,
  ...
  constexpr ControllerParameters
  withZeroWaitDuration (uint32_t value) const
  {
    return ControllerParameters (
        ramp_mode,
        stop_mode,
  ...
  constexpr ControllerParameters
  withStallStopEnabled (bool value) const
  {
    return ControllerParameters (
        ramp_mode,
        stop_mode,
  ...
  constexpr ControllerParameters
  withMinDcStepVelocity (uint32_t value) const
  {
    return ControllerParameters (
        ramp_mode,
        stop_mode,
