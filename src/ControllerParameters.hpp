...
struct ControllerParameters {
  ...
  constexpr ControllerParameters(
      ...
      uint32_t zero_wait_duration = 0, bool stall_stop_enabled = false,
      uint32_t min_dc_step_velocity = 0)
      : ramp_mode(ramp_mode), stop_mode(stop_mode), max_velocity(max_velocity),
        max_acceleration(max_acceleration), start_velocity(start_velocity),
        stop_velocity(stop_velocity), first_velocity(first_velocity),
  ...
  constexpr ControllerParameters withRampMode(RampMode value) const {
    return ControllerParameters(
        value, stop_mode, max_velocity, max_acceleration, start_velocity,
        stop_velocity, first_velocity, first_acceleration, max_deceleration,
        first_deceleration, zero_wait_duration, stall_stop_enabled,
        min_dc_step_velocity);
  }

  constexpr ControllerParameters withStopMode(StopMode value) const {
    return ControllerParameters(
        ramp_mode, value, max_velocity, max_acceleration, start_velocity,
        stop_velocity, first_velocity, first_acceleration, max_deceleration,
        first_deceleration, zero_wait_duration, stall_stop_enabled,
        min_dc_step_velocity);
  }
  ...
  constexpr ControllerParameters withMaxVelocity(uint32_t value) const {
    return ControllerParameters(ramp_mode, stop_mode, value, max_acceleration,
                                start_velocity, stop_velocity, first_velocity,
                                first_acceleration, max_deceleration,
                                first_deceleration, zero_wait_duration,
                                stall_stop_enabled, min_dc_step_velocity);
  }

  constexpr ControllerParameters withMaxAcceleration(uint32_t value) const {
    return ControllerParameters(ramp_mode, stop_mode, max_velocity, value,
                                start_velocity, stop_velocity, first_velocity,
                                first_acceleration, max_deceleration,
                                first_deceleration, zero_wait_duration,
                                stall_stop_enabled, min_dc_step_velocity);
  ...
  constexpr ControllerParameters withStartVelocity(uint32_t value) const {
    return ControllerParameters(
        ramp_mode, stop_mode, max_velocity, max_acceleration, value,
        stop_velocity, first_velocity, first_acceleration, max_deceleration,
        first_deceleration, zero_wait_duration, stall_stop_enabled,
        min_dc_step_velocity);
  }
  ...
  constexpr ControllerParameters withStopVelocity(uint32_t value) const {
    return ControllerParameters(
        ramp_mode, stop_mode, max_velocity, max_acceleration, start_velocity,
        value, first_velocity, first_acceleration, max_deceleration,
        first_deceleration, zero_wait_duration, stall_stop_enabled,
        min_dc_step_velocity);
  }

  constexpr ControllerParameters withFirstVelocity(uint32_t value) const {
    return ControllerParameters(ramp_mode, stop_mode, max_velocity,
                                max_acceleration, start_velocity, stop_velocity,
                                value, first_acceleration, max_deceleration,
                                first_deceleration, zero_wait_duration,
                                stall_stop_enabled, min_dc_step_velocity);
  }
  ...
  constexpr ControllerParameters withFirstAcceleration(uint32_t value) const {
    return ControllerParameters(ramp_mode, stop_mode, max_velocity,
                                max_acceleration, start_velocity, stop_velocity,
                                first_velocity, value, max_deceleration,
                                first_deceleration, zero_wait_duration,
                                stall_stop_enabled, min_dc_step_velocity);
  }
  ...
  constexpr ControllerParameters withMaxDeceleration(uint32_t value) const {
    return ControllerParameters(ramp_mode, stop_mode, max_velocity,
                                max_acceleration, start_velocity, stop_velocity,
                                first_velocity, first_acceleration, value,
                                first_deceleration, zero_wait_duration,
                                stall_stop_enabled, min_dc_step_velocity);
  }
  ...
  constexpr ControllerParameters withFirstDeceleration(uint32_t value) const {
    return ControllerParameters(
        ramp_mode, stop_mode, max_velocity, max_acceleration, start_velocity,
        stop_velocity, first_velocity, first_acceleration, max_deceleration,
        value, zero_wait_duration, stall_stop_enabled, min_dc_step_velocity);
  }
  ...
  constexpr ControllerParameters withZeroWaitDuration(uint32_t value) const {
    return ControllerParameters(
        ramp_mode, stop_mode, max_velocity, max_acceleration, start_velocity,
        stop_velocity, first_velocity, first_acceleration, max_deceleration,
        first_deceleration, value, stall_stop_enabled, min_dc_step_velocity);
  }
  ...
  constexpr ControllerParameters withStallStopEnabled(bool value) const {
    return ControllerParameters(
        ramp_mode, stop_mode, max_velocity, max_acceleration, start_velocity,
        stop_velocity, first_velocity, first_acceleration, max_deceleration,
        first_deceleration, zero_wait_duration, value, min_dc_step_velocity);
  }
  ...
  constexpr ControllerParameters withMinDcStepVelocity(uint32_t value) const {
    return ControllerParameters(
        ramp_mode, stop_mode, max_velocity, max_acceleration, start_velocity,
        stop_velocity, first_velocity, first_acceleration, max_deceleration,
        first_deceleration, zero_wait_duration, stall_stop_enabled, value);
  }
};
} // namespace tmc51x0
