...
struct UartParameters
{
  ...
  constexpr UartParameters
  withNodeAddress (uint8_t na) const
  {
    return UartParameters (
        uart_ptr,
        na,
  ...
  constexpr UartParameters
  withEnableTxRxPin (size_t en) const
  {
    return UartParameters (
        uart_ptr,
        node_address,
  ...
  constexpr UartParameters
  withBaudRate (uint32_t br) const
  {
    return UartParameters (
        uart_ptr,
        node_address,
  ...
  constexpr UartParameters
  withReplyTimeoutUs (uint32_t timeout_us) const
  {
    return UartParameters (
        uart_ptr,
        node_address,
  ...
  constexpr UartParameters
  withEnableDelayUs (uint32_t delay_us) const
  {
    return UartParameters (
        uart_ptr,
        node_address,
  ...
  constexpr UartParameters
  withMaxRetries (uint8_t retries) const
  {
    return UartParameters (
        uart_ptr,
        node_address,
  ...
  constexpr UartParameters
  withTxCompleteDelayUs (uint32_t delay_us) const
  {
    return UartParameters (
        uart_ptr,
        node_address,
